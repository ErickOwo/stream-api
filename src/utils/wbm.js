 ...
 */
async function send(phoneOrContactsAndMessage) {
  for (let phoneOrContactAndMessage of phoneOrContactsAndMessage) {
    await sendTo(phoneOrContactAndMessage.phone, phoneOrContactAndMessage.message);
  }
}
